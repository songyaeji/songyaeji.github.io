...
summary: 다크웹 유출·랜섬웨어 동향을 MITRE ATT&CK과 매칭하는 위협 인텔리전스 대시보드.
year: 2025
category: team
status: done
...
사이버 위협 데이터를 자동으로 수집·분석·시각화하는 경희대 팀 프로젝트. 담당 부분은
OSINT로 다크웹 유출 정보와 랜섬웨어 그룹 활동을 크롤링해 분석의 원천 데이터셋을
구축한 것이다.

팀 전체로는 MITRE ATT&CK 기법을 보안 뉴스·CVE와 의미 기반으로 매칭하고, 결과를
